...
2) It can feel the devices' direction, and show some arrows on your device.
3) You can slide to throw a file or another object to an arrow to share the object with target device.
